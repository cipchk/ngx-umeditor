...
export class ScriptService {
    ...
    load(path: string, debug?:boolean) {
        ...
        this.loadLib(path).then(() => {
            ...
            promises.push(this.loadCss(`${path}/themes/default/css/umeditor.min.css`));

            [ `${path}umeditor.config.js`, debug === true ? `${path}/umeditor.js` : `${path}/umeditor.all.min.js` ].forEach((script) => promises.push(this.loadScript(script)));
